...
set CLASSPATH=%APP_HOME%\lib\lab03-1.0.jar;%APP_HOME%\lib\commons-csv-1.9.0.jar

@rem Execute lab03
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB03_OPTS%  -classpath "%CLASSPATH%" csci2020u.lab02.CSVDemo %CMD_LINE_ARGS%
